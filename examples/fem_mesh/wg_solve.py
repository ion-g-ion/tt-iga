...
def create_file_and_mesh(theta,meshsize = 0.5):
    ...
    with open('./examples/fem_mesh/wg_proto_nomat.geo', 'r') as file:
        data = file.read()
...
class SolverWG():
    ...
    def solve_helmholz(self,k = 64):
        ...
        u = fn.TrialFunction(V)
        v = fn.TestFunction(V)
        a =fn.dot(fn.grad(u), fn.grad(v)) * fn.dx - fn.Constant(k)*u*v*fn.dx
...
if __name__ == "__main__":
    ...
    solver_fine.set_params([0.1]*4,0.05/5)
 ...
 #   tme_solve = solver_fine.solve_laplace()
    ...
    tme_solve = solver_fine.solve_helmholz(50)
